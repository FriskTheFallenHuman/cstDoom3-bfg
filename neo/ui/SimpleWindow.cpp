...
//	}
	...
	//#modified-fva; BEGIN
	int cstCinematicStartTime_Game;
	savefile->ReadInt(cstCinematicStartTime_Game);
	if (background) {
		background->CstResetCinematicTime_Game(cstCinematicStartTime_Game);
	}
	//#modified-fva; END
}
