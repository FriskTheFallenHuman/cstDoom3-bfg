...
public:
	...
	int						weapon_chainsaw;
	//#modified-fva; BEGIN
	int						cst_weapon_grabber;
	int						cst_weapon_shotgun;
	int						cst_weapon_shotgun_double;
	...
	//#modified-fva; BEGIN
	int						cstAwDoubleBarrelShotgunD3;
	int						cstAwGrabberD3;
...
public:
	...
	//#modified-fva; BEGIN
	void					CstShowLastTip();
	bool					CstIsObjectiveUp() const { return objectiveUp; }
	bool					CstIsObjectiveCompleteUp() const { return cstObjectiveCompleteUp; }
	bool					CstIsNewVideoUp() const { return cstNewVideoUp; }
	bool					CstIsNewPDAUp() const { return cstNewPDAUp; }
	//#modified-fva; END
private:
	// Stats & achievements
	...
	//#modified-fva; BEGIN
	struct CstTipInfo {
				CstTipInfo() : autoHide(true) {}
		void	Clear() { title.Clear(); tip.Clear(); autoHide = true; }

		idStr	title;
		idStr	tip;
		bool	autoHide;
	};
	CstTipInfo				cstLastTip;
	//#modified-fva; END
	bool					objectiveUp;
	//#modified-fva; BEGIN
	bool					cstObjectiveCompleteUp;
	bool					cstNewVideoUp;
	bool					cstNewPDAUp;
	//#modified-fva; END
	...
	//#modified-fva; BEGIN
	void					Event_CstDamage(const char *damageDef);
	void					Event_CstGetAwDbsD3();
	void					Event_CstGetAwGrabberD3();
	void					Event_CstGetAwChainsawRoE();
	void					Event_CstGetAwChainsawLM();
	//#modified-fva; END
	...
	public:
		...
		void					ReadFromSnapshot(idPlayer *owner, const idBitMsg &msg);
	...
	CstCrouchRate			cstCrouchRate;

	int						cstArmorFlashlightHideModel;
