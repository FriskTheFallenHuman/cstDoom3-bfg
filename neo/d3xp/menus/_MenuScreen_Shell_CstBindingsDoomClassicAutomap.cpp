...
static idMenuScreen_Shell_CstBindingsBase::bindInfo_t keyboardBindsDoomClassicAutomap[] = {
	{ CST_STR_00300088,					"",							NULL				},	// HEADING: CONTROLS - AUTOMAP SPECIFIC
	{ CST_STR_00300089,					"_cstAutomapPanUp",			CST_STR_00300103	},	// Pan Up
	{ CST_STR_00300090,					"_cstAutomapPanDown",		CST_STR_00300104	},	// Pan Down
	{ CST_STR_00300091,					"_cstAutomapPanLeft",		CST_STR_00300105	},	// Pan Left
	{ CST_STR_00300092,					"_cstAutomapPanRight",		CST_STR_00300106	},	// Pan Right
	{ CST_STR_00300093,					"cstAutomapStepZoomIn",		CST_STR_00300107	},	// Step Zoom In
	{ CST_STR_00300094,					"cstAutomapStepZoomOut",	CST_STR_00300108	},	// Step Zoom Out
	{ CST_STR_00300095,					"cstAutomapFullZoomOut",	CST_STR_00300109	},	// Full Zoom Out
	{ CST_STR_00300096,					"_cstAutomapZoomIn",		CST_STR_00300110	},	// Zoom In
	{ CST_STR_00300097,					"_cstAutomapZoomOut",		CST_STR_00300111	},	// Zoom Out
	{ CST_STR_00300098,					"_cstAutomapGoBig",			CST_STR_00300112	},	// Go Big
	{ CST_STR_00300099,					"_cstAutomapFollow",		CST_STR_00300113	},	// Follow
	{ CST_STR_00300100,					"_cstAutomapGrid",			CST_STR_00300114	},	// Grid
	{ CST_STR_00300101,					"_cstAutomapMark",			CST_STR_00300115	},	// Mark
	{ CST_STR_00300102,					"_cstAutomapClearMark",		CST_STR_00300116	},	// Clear Mark


	// The section below is a copy of keyboardBindsDoomClassicNormal from _MenuScreen_Shell_CstBindingsDoomClassicNormal.cpp
...
/*
========================
idMenuScreen_Shell_CstBindingsDoomClassicAutomap::idMenuScreen_Shell_CstBindingsDoomClassicAutomap
========================
*/
idMenuScreen_Shell_CstBindingsDoomClassicAutomap::idMenuScreen_Shell_CstBindingsDoomClassicAutomap() {
	keyboardBinds = keyboardBindsDoomClassicAutomap;
	numBinds = sizeof(keyboardBindsDoomClassicAutomap) / sizeof(keyboardBindsDoomClassicAutomap[0]);
	bindingsDomain = 2; // 0 = Doom 3; 1 = Doom 1 & 2; 2 = Doom 1 & 2 Automap
	menuSpriteName = "cstMenuBindingsDoomClassicAutomap";
	shellArea = CST_SHELL_AREA_BINDINGS_DOOM_CLASSIC_AUTOMAP;
	headingLabel = CST_STR_00300087;
