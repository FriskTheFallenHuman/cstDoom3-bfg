...
public:
	...
	//#modified-fva; BEGIN
	void					CstSetForceAllowTooltip(const bool b) { cstForceAllowTooltip = b; }
	//#modified-fva; END
...
public:
	...
	//#modified-fva; BEGIN
	void						CstSetForceAllowTooltip(bool val) { cstForceAllowTooltip = val; }
	//#modified-fva; END
