...
enum shellAreas_t {
	...
	SHELL_AREA_SETTINGS,
	SHELL_AREA_CONTROLS,
	CST_SHELL_AREA_BINDINGS_DOOM3,
	CST_SHELL_AREA_BINDINGS_DOOM_CLASSIC_NORMAL,
	CST_SHELL_AREA_BINDINGS_DOOM_CLASSIC_AUTOMAP,
	SHELL_AREA_GAMEPAD,
	CST_SHELL_AREA_GAME_OPTIONS_DOOM3,
	CST_SHELL_AREA_GO_D3_GENERAL_OPTIONS_1,
	CST_SHELL_AREA_GO_D3_GENERAL_OPTIONS_2,
	CST_SHELL_AREA_GO_D3_GENERAL_OPTIONS_3,
	CST_SHELL_AREA_GO_D3_RUN_CROUCH_ZOOM,
	CST_SHELL_AREA_GO_D3_MAP_OPTIONS,
	CST_SHELL_AREA_GO_D3_WEAPON_OPTIONS,
	CST_SHELL_AREA_GO_D3_WEAPON_SMOKE_SELF,
	CST_SHELL_AREA_GO_D3_WEAPON_SMOKE_OTHERS_MP,
	CST_SHELL_AREA_GO_D3_PROJECTILE_SMOKE_SELF,
	CST_SHELL_AREA_GO_D3_PROJECTILE_SMOKE_OTHERS_MP,
	CST_SHELL_AREA_GO_D3_DAMAGE_FEEDBACK,
	CST_SHELL_AREA_GO_D3_SERVER_OPTIONS,
	CST_SHELL_AREA_GAME_OPTIONS_DOOM_CLASSIC,
	CST_SHELL_AREA_GO_DC_GENERAL_OPTIONS_1,
	CST_SHELL_AREA_GO_DC_AUTOMAP_OPTIONS,
	CST_SHELL_AREA_GO_DC_RUN_OPTIONS,
	CST_SHELL_AREA_GO_DC_SCREEN_OPTIONS,
	SHELL_AREA_RESOLUTION,
	SHELL_AREA_SYSTEM_OPTIONS,
	CST_SHELL_AREA_SYSTEM_OPTIONS_2,
	CST_SHELL_AREA_PRESETS,
	CST_SHELL_AREA_ACHIEVEMENTS,
	CST_SHELL_AREA_HELP,
	//#modified-fva; END
	SHELL_NUM_AREAS
};
...
static const int MAX_SCREEN_AREAS = 64;
//#modified-fva; END
...
public:
	idMenuHandler_Shell() :
		//#modified-fva; BEGIN
		cstHelpGoBackScreen(SHELL_AREA_INVALID),
		//#modified-fva; END
		...
		waitBind( NULL ),
		//#modified-fva; BEGIN
		cstWaitShellArea(SHELL_AREA_INVALID),
		//#modified-fva; END
		newGameType( 0 ),
		menuBar( NULL ),
		pacifier( NULL ),
	...
	void					SetWaitForBinding(const char *bind, shellAreas_t cstShellArea) { waitForBinding = true; waitBind = bind; cstWaitShellArea = cstShellArea; }
	//#modified-fva; END
	...
	//#modified-fva; BEGIN
	bool					CstIsShowingIntro() { return showingIntro; }
	idStr					cstHelpText;
	shellAreas_t			cstHelpGoBackScreen;
	//#modified-fva; END
...
public:
	...
	//#modified-fva; BEGIN
	bool					CstIsRadioActive() { return radioMessage; }
	//#modified-fva; END
