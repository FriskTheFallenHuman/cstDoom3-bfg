...
idCVar g_fov("g_fov", "80", CVAR_GAME | CVAR_FLOAT | CVAR_ARCHIVE, "");
//#modified-fva; END
...
//#modified-fva; BEGIN
#ifdef ID_RETAIL
idCVar cst_showDefaultLightModel("cst_showDefaultLightModel", "0", CVAR_GAME | CVAR_BOOL | CVAR_NOCHEAT, "show a black box for missing light models");
#else
idCVar cst_showDefaultLightModel("cst_showDefaultLightModel", "1", CVAR_GAME | CVAR_BOOL | CVAR_NOCHEAT, "show a black box for missing light models");
#endif

idCVar cst_keyPdaScoreClose("cst_keyPdaScoreClose", "", CVAR_GAME | CVAR_ARCHIVE, "extra key to close the PDA and the scoreboard");
...
idCVar cst_allowHeadlampMP("cst_allowHeadlampMP", "0", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE | CVAR_SERVERINFO, "allow headlamp in multiplayer");
...
idCVar cst_allowSmokeControlMP("cst_allowSmokeControlMP", "0", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE | CVAR_SERVERINFO, "allow fly/muzzle smoke control in multiplayer");
...
idCVar cst_allowDamageFeedbackControlMP("cst_allowDamageFeedbackControlMP", "0", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE | CVAR_SERVERINFO, "allow damage feedback control in multiplayer");
...
idCVar cst_hudSmartAmmoSP("cst_hudSmartAmmoSP", "0", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE, "don't show ammo on the HUD for weapons that have an ammo display - singleplayer");
idCVar cst_hudSmartAmmoMP("cst_hudSmartAmmoMP", "0", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE, "don't show ammo on the HUD for weapons that have an ammo display - multiplayer");
idCVar cst_allowHandFlashlightMP("cst_allowHandFlashlightMP", "0", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE | CVAR_SERVERINFO, "allow the handheld flashlight in multiplayer");
idCVar cst_awDoubleBarrelShotgunD3("cst_awDoubleBarrelShotgunD3", "0", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE, "spawn the Double Barrel Shotgun in Doom 3");
idCVar cst_awGrabberD3("cst_awGrabberD3", "0", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE, "spawn the Grabber in Doom 3");
idCVar cst_awChainsawRoE("cst_awChainsawRoE", "0", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE, "spawn the Chainsaw in RoE");
idCVar cst_awChainsawLM("cst_awChainsawLM", "0", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE, "spawn the Chainsaw in LM");
idCVar cst_oldPlayerSpeedSP("cst_oldPlayerSpeedSP", "0", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE, "use the player speed from the original Doom 3 (slower movement) in singleplayer");
idCVar cst_oldPlayerSpeedMP("cst_oldPlayerSpeedMP", "0", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE | CVAR_SERVERINFO, "use the player speed from the original Doom 3 (slower movement) in multiplayer");
idCVar cst_oldHealthStation("cst_oldHealthStation", "0", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE, "use the health station values from the original Doom 3");
idCVar cst_oldAmmoD3("cst_oldAmmoD3", "0", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE, "use the ammo pickup values from the original Doom 3 (less ammo) in the Doom 3 campaign");
idCVar cst_oldAmmoRoE("cst_oldAmmoRoE", "0", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE, "use the ammo pickup values from the original Doom 3 (less ammo) in the RoE campaign");
idCVar cst_oldAmmoLM("cst_oldAmmoLM", "0", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE, "use the ammo pickup values from the original Doom 3 (less ammo) in the Lost Mission campaign");
idCVar cst_oldAmmoMP("cst_oldAmmoMP", "0", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE | CVAR_SERVERINFO, "use the ammo pickup values from the original Doom 3 (less ammo) in multiplayer");
idCVar cst_mapEnpro_noLiftLamp("cst_mapEnpro_noLiftLamp", "0", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE, "remove the lift lamp in enpro");
idCVar cst_mapEnpro_noTwoTonePipe("cst_mapEnpro_noTwoTonePipe", "0", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE, "replace the two-tone sound of a certain pipe in enpro with a regular gas sound, and reduce the volume of other pipes nearby");
idCVar cst_mapHell1_doorFire("cst_mapHell1_doorFire", "0", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE, "enable the fire effect of a certain door in hell1");
idCVar cst_mapErebus5_enviroSuit("cst_mapErebus5_enviroSuit", "0", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE, "enable the envirosuit in erebus5");
idCVar cst_mapDeltaX_phasing("cst_mapDeltaX_phasing", "0", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE, "enable the hell phasing in deltax");
idCVar cst_mapLeEnpro2_noLiftLamp("cst_mapLeEnpro2_noLiftLamp", "0", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE, "remove the lamp of the power core lift in le_enpro2");
idCVar cst_mapLeUnderground_noHissPipe("cst_mapLeUnderground_noHissPipe", "0", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE, "disable the high pitched sounds of a certain pipe in le_underground");
idCVar cst_no1kMakeMadDrone("cst_no1kMakeMadDrone", "0", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE, "disable the 1k_make_mad_drone sound sample");
idCVar cst_crosshairAlwaysShow("cst_crosshairAlwaysShow", "0", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE, "don't hide the crosshair when switching or reloading weapons");
...
// cst_grenadesToggle is in "neo\sys\sys_session_local.cpp"
idCVar cst_allowGrenadesToggleMP("cst_allowGrenadesToggleMP", "0", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE | CVAR_SERVERINFO, "allow grenades toggle in multiplayer");
idCVar cst_useViewNodal("cst_useViewNodal", "1", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE, "simulate the distance from the eyes to the neck");
idCVar cst_armorFlashlightHideModel("cst_armorFlashlightHideModel", "0", CVAR_GAME | CVAR_INTEGER | CVAR_ARCHIVE, "hide the armor-mounted flashlight:\n0 = don't hide; 1 = hide shadow only; 2 = hide model", 0, 2);
...
// cst_autoReloadAlwaysDbs is in "neo\sys\sys_session_local.cpp"
idCVar cst_instaReloadSP("cst_instaReloadSP", "0", CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE, "enable instantaneous weapon reload in singleplayer");
//#modified-fva; END
