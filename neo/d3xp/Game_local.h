...
public:
	...
	bool					cstSiAllowHandFlashlightMP;
	bool					cstSiOldPlayerSpeedMP;
	bool					cstSiOldAmmoMP;
	...
	//#modified-fva; BEGIN
	virtual bool			CstIsInCinematic() { return inCinematic; }
	virtual bool			CstSkipCinematic();
	virtual void			CstSyncPlayersWithLobbyUsers() { SyncPlayersWithLobbyUsers(false); }
	virtual bool			Cst_Shell_IsShowingIntro();
	virtual bool			Cst_Shell_IsGameComplete();
	virtual void			CstRequestCinematicUpdate(const idMaterial * cinematicMaterial, int time);
	virtual void			CstGenUpdateCinematicCmds();
	//#modified-fva; END
	...
	void					CalcFov(float base_fov, float &fov_x, float &fov_y, bool cstOldStyle = false) const;
	//#modified-fva; END
...
private:
	...
	//#modified-fva; BEGIN
	struct CstCinUpdateData {
		const idMaterial *		material;
		int						time;
	};
	idList<CstCinUpdateData>	cstCinematicUpdateList;
	//#modified-fva; END
	...
	//#modified-fva; BEGIN
	void					CstAdjustCinematicUpdateListTime(int time);
	void					CstClearCinematicUpdateList();
	//#modified-fva; END
};
