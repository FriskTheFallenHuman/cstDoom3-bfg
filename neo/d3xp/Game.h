...
public:
	...
	//#modified-fva; BEGIN
	virtual bool				CstIsInCinematic() = 0;
	virtual bool				CstSkipCinematic() = 0;
	virtual void				CstSyncPlayersWithLobbyUsers() = 0;
	virtual bool				Cst_Shell_IsShowingIntro() = 0;
	virtual bool				Cst_Shell_IsGameComplete() = 0;
	virtual void				CstRequestCinematicUpdate(const idMaterial * cinematicMaterial, int time) = 0;
	virtual void				CstGenUpdateCinematicCmds() = 0;
	//#modified-fva; END
