...
public:
	...
	//#modified-fva; BEGIN
							// Similar to OpenFileReadMemory, but guaranteed to return an idFile_Memory
	virtual idFile *		CstOpenFileRead_FileMemory(const char *relativePath, bool allowCopyFiles = true, const char* gamedir = NULL) = 0;
	//#modified-fva; END
...
//#modified-fva; BEGIN
extern idCVar cst_exportPath;
extern idCVar cst_resourcesAddAll;
//#modified-fva; END
