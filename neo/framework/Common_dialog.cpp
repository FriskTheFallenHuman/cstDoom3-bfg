...
static const char * dialogStateToString[ GDM_MAX + 1 ] = {
	...
	//#modified-fva; BEGIN
	ASSERT_ENUM_STRING(CST_GDM_RESET_ALL_DEFAULTS, 139),
	ASSERT_ENUM_STRING(CST_GDM_DEFAULT_CONTROLS_DOOM3, 140),
	ASSERT_ENUM_STRING(CST_GDM_DEFAULT_CONTROLS_DOOM_CLASSIC, 141),
	ASSERT_ENUM_STRING(CST_GDM_LAYERED_CONTROLS_DOOM3, 142),
	ASSERT_ENUM_STRING(CST_GDM_LAYERED_CONTROLS_DOOM_CLASSIC, 143),
	ASSERT_ENUM_STRING(CST_GDM_RESET_ACHIEVEMENTS, 144),
	ASSERT_ENUM_STRING(CST_GDM_RESET_ACHIEVEMENTS_2, 145),
	ASSERT_ENUM_STRING(CST_GDM_DEFAULTED_FULLSCREEN, 146),
	//#modified-fva; END
	//#modified-fva; BEGIN
	//ASSERT_ENUM_STRING( GDM_MAX, 139 )
	ASSERT_ENUM_STRING(GDM_MAX, 147)
	//#modified-fva; END
};
