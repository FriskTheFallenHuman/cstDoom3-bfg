...
enum gameDialogMessages_t {
	...
	//#modified-fva; BEGIN
	CST_GDM_RESET_ALL_DEFAULTS,
	CST_GDM_DEFAULT_CONTROLS_DOOM3,
	CST_GDM_DEFAULT_CONTROLS_DOOM_CLASSIC,
	CST_GDM_LAYERED_CONTROLS_DOOM3,
	CST_GDM_LAYERED_CONTROLS_DOOM_CLASSIC,
	CST_GDM_RESET_ACHIEVEMENTS,
	CST_GDM_RESET_ACHIEVEMENTS_2,
	CST_GDM_DEFAULTED_FULLSCREEN,
	//#modified-fva; END
	GDM_MAX
};
