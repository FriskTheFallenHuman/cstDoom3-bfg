...
struct lobbyUser_t {
	...
	lobbyUser_t() {
		...
		//#modified-fva; BEGIN
		cstGrenadesToggle		= false;
		cstAutoReloadAlwaysDbs	= false;
		//#modified-fva; END
	...
	//#modified-fva; BEGIN
	bool				cstGrenadesToggle;
	bool				cstAutoReloadAlwaysDbs;
	//#modified-fva; END
	...
	void WriteClientMutableData( idBitMsg & msg ) {
		...
		//#modified-fva; BEGIN
		msg.WriteBool(cstGrenadesToggle);
		msg.WriteBool(cstAutoReloadAlwaysDbs);
		msg.WriteBits(0, 6); // dummy write to complete the last byte
		//#modified-fva; END
	...
	void ReadClientMutableData( idBitMsg & msg ) {
		...
		//#modified-fva; BEGIN
		cstGrenadesToggle = msg.ReadBool();
		cstAutoReloadAlwaysDbs = msg.ReadBool();
		msg.ReadBits(6); // dummy read to complete the last byte
		//#modified-fva; END
	}
};
