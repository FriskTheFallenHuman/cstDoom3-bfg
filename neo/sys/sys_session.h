...
public:
	...
	//#modified-fva; BEGIN
	virtual bool						CstGetLobbyUserGrenadesToggle(lobbyUserID_t lobbyUserID) const = 0;
	virtual bool						CstGetLobbyUserAutoReloadAlwaysDbs(lobbyUserID_t lobbyUserID) const = 0;
	//#modified-fva; END
