...
public:
	...
	//#modified-fva; BEGIN
	virtual bool						CstGetLobbyUserGrenadesToggle(lobbyUserID_t lobbyUserID) const { return false; }
	virtual bool						CstGetLobbyUserAutoReloadAlwaysDbs(lobbyUserID_t lobbyUserID) const { return false; }
	//#modified-fva; END
