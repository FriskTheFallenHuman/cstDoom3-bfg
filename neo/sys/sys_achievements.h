...
public:
	...
	virtual void	AchievementUnlock(idLocalUser * user, const int achievementID, bool cstNotify) = 0;
	//#modified-fva; END
	...
	virtual bool	GetAchievementDescription(const int id, achievementDescription_t & data, bool getLocalizationKeys) const { return false; }
	//#modified-fva; END
