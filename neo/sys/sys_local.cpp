...
idCVar sys_lang("sys_lang", ID_LANG_ENGLISH, CVAR_SYSTEM | CVAR_ARCHIVE, "", sysLanguageNames, idCmdSystem::ArgCompletion_String<sysLanguageNames>);
//#modified-fva; END
...
const char *Sys_TimeStampToStr( ID_TIME_T timeStamp ) {
	...
	const idStr &lang = common->CstGetLatchedLanguage();
	//#modified-fva; END
