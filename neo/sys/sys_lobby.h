...
public:		// Turning this on for now, for the sake of getting this up and running to see where things are
	...
	//#modified-fva; BEGIN
	virtual bool						CstGetLobbyUserGrenadesToggle(lobbyUserID_t lobbyUserID) const;
	virtual bool						CstGetLobbyUserAutoReloadAlwaysDbs(lobbyUserID_t lobbyUserID) const;
	//#modified-fva; END
	...
	void								HandleReliableMsg(int p, idBitMsg & msg, const lobbyAddress_t & cstRemoteAddress);
	//#modified-fva; END
