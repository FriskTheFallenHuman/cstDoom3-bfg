...
//#modified-fva; BEGIN
#define	SAVEGAME_DETAIL_FIELD_CST_AW_DBS_D3			"cstAwDbsD3"
#define	SAVEGAME_DETAIL_FIELD_CST_AW_GRABBER_D3		"cstAwGrabberD3"
#define	SAVEGAME_DETAIL_FIELD_CST_AW_CHAINSAW_ROE	"cstAwChainsawRoE"
#define	SAVEGAME_DETAIL_FIELD_CST_AW_CHAINSAW_LM	"cstAwChainsawLM"
//#modified-fva; END
...
public:
	...
	//#modified-fva; BEGIN
	int		CstGetAwDbsD3() const { return descriptors.GetInt(SAVEGAME_DETAIL_FIELD_CST_AW_DBS_D3, -1); }
	int		CstGetAwGrabberD3() const { return descriptors.GetInt(SAVEGAME_DETAIL_FIELD_CST_AW_GRABBER_D3, -1); }
	int		CstGetAwChainsawRoE() const { return descriptors.GetInt(SAVEGAME_DETAIL_FIELD_CST_AW_CHAINSAW_ROE, -1); }
	int		CstGetAwChainsawLM() const { return descriptors.GetInt(SAVEGAME_DETAIL_FIELD_CST_AW_CHAINSAW_LM, -1); }
	//#modified-fva; END
