...
public:
	...
	//#modified-fva; BEGIN
	virtual void			CstSetShaderParms(int timeMsec, const idVec4 &colorRgba) = 0;
	//#modified-fva; END
	...
	//#modified-fva; BEGIN
	virtual void			CstDrawSmallChar(float x, float y, float wScale, float hScale, int ch) = 0;
	//#modified-fva; END
	...
	virtual void			CropRenderSize(int width, int height, bool cstOldStyle) = 0;
	//#modified-fva; END
	...
	//#modified-fva; BEGIN
	virtual void			CstGenUpdateCinematicCmd(const idMaterial * cinMaterial, int time) = 0;
	virtual void			CstUpdateCinematicsNowOutsideRender() = 0;
	virtual void			CstClearColorBufferNowOutsideRender(float r, float g, float b) = 0;
	//#modified-fva; END
};
