...
//#modified-fva; BEGIN
struct cstUpdateCinematicCommand_t {
	renderCommand_t		commandId;
	renderCommand_t *	next;
	const idMaterial *	cinMaterial;
	int					time;
};
//#modified-fva; END
...
public:
	...
	//#modified-fva; BEGIN
	virtual void			CstSetShaderParms(int timeMsec, const idVec4 &colorRgba);
	//#modified-fva; END
	...
	//#modified-fva; BEGIN
	virtual void			CstDrawSmallChar(float x, float y, float wScale, float hScale, int ch);
	//#modified-fva; END
	...
	virtual void			CropRenderSize(int width, int height, bool cstOldStyle);
	//#modified-fva; END
	...
	//#modified-fva; BEGIN
	virtual void			CstGenUpdateCinematicCmd(const idMaterial * cinMaterial, int time);
	virtual void			CstUpdateCinematicsNowOutsideRender();
	virtual void			CstClearColorBufferNowOutsideRender(float r, float g, float b);
	//#modified-fva; END
...
public:
	...
	//#modified-fva; BEGIN
	bool					cstUseShaderParms;
	int						cstShaderMsec;
	idVec4					cstShaderColor;
	//#modified-fva; END
...
*/
extern idCVar cst_vidFullscreen;
//#modified-fva; END
...
//#modified-fva; BEGIN
extern bool gCstLatched__r_useGPUSkinning;
//#modified-fva; END
...
bool R_GetModeListForDisplay(const int displayNum, idList<vidMode_t> &modeList, const int cstMinHeight);
...
//#modified-fva; BEGIN
void RB_CstUpdateCinematic(const void *data);
//#modified-fva; END
