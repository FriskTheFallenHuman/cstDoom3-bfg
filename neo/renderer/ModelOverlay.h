...
//#modified-fva; BEGIN
struct cstOverlaySurfaces_t {
	cstOverlaySurfaces_t();
	const idMaterial *				material;
...
private:
	...
	*/
	idList<cstOverlaySurfaces_t, TAG_MODEL>			cstOverlays;
	idList<overlayProjectionParms_t, TAG_MODEL>		cstDeferredOverlays;
	//#modified-fva; END
