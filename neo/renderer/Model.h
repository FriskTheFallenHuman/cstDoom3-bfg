...
public:
	...
	//#modified-fva; BEGIN
	virtual bool				CstIsGpuSkinningSyncRequired() { return false; }
	virtual short				CstGetUseGpuSkinning() { return -1; }
	virtual void				CstSetUseGpuSkinning(bool useGpuSkinning) { }
	virtual bool				CstGetShowingSkel() { return false; }
	//#modified-fva; END
};
