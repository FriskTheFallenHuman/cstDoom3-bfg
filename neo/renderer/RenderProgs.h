...
public:
	...
	//#modified-fva; BEGIN
	void	CstBindShader(int programIndex);
	//#modified-fva; END
	...
	//#modified-fva; BEGIN
	void	BindShader_CstDebugPosColor() { BindShader_Builtin(BUILTIN_CST_DEBUG_POS_COLOR); }
	void	BindShader_CstDebugDepth() { BindShader_Builtin(BUILTIN_CST_DEBUG_DEPTH); }
	void	BindShader_CstDebugColorSkinned() { BindShader_Builtin(BUILTIN_CST_DEBUG_COLOR_SKINNED); }
	//#modified-fva; END
...
protected:
	...
	enum {
		...
		//#modified-fva; BEGIN
		BUILTIN_CST_DEBUG_POS_COLOR,
		BUILTIN_CST_DEBUG_DEPTH,
		BUILTIN_CST_DEBUG_COLOR_SKINNED,
		//#modified-fva; END
