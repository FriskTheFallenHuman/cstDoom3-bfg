...
public:
	...
	//#modified-fva; BEGIN
	virtual bool				CstIsGpuSkinningSyncRequired() { return cstRequiresGpuSkinningSync; }
	void						CstSetRequiresGpuSkinningSync(bool isRequired) { cstRequiresGpuSkinningSync = isRequired; }
	virtual short				CstGetUseGpuSkinning() { return cstUseGpuSkinning; }
	virtual void				CstSetUseGpuSkinning(bool useGpuSkinning) { cstUseGpuSkinning = (short)useGpuSkinning; }
	virtual bool				CstGetShowingSkel() { return cstShowingSkel; }
	void						CstSetShowingSkel(bool showingSkel) { cstShowingSkel = showingSkel; }
	//#modified-fva; END
...
protected:
	...
	//#modified-fva; BEGIN
	bool						cstRequiresGpuSkinningSync;
	short						cstUseGpuSkinning;
	bool						cstShowingSkel;
	//#modified-fva; END
	ID_TIME_T					timeStamp;
