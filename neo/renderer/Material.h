...
public:
	...
	*/
	void				CstResetCinematicTime_Game(int time) const;
	void				CstResetCinematicTime_Sys(int time) const;
	int					CstGetCinematicStartTime_Game() const;
	int					CstGetCinematicStartTime_Sys() const;
	//#modified-fva; END

	void				UpdateCinematic( int time ) const;

	//#modified-fva; BEGIN
	bool				CstCinematicIsPlaying_Game();
	bool				CstCinematicIsPlaying_Sys();
	bool				CstHasCinematic() const;
	int					CstCinematicIsTheora() const; // -1 = no cinematic, 0 = no, 1 = yes
	//#modified-fva; END
