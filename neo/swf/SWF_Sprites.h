...
public:
	...
	void	Write( idFile * f );
	//#modified-fva; BEGIN
	bool	CstWriteJson(JsonPrettyWriter &writer, bool isMain, unsigned characterID, idList<idStr> &errorMsg);
	void	CstLoadJson(JsonValue &objSprite, const idList<idStr> &characterIDs, idList<idStr> &errorMsg);
	//#modified-fva; END
