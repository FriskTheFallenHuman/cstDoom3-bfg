...
public:
	...
	//#modified-fva; BEGIN
	static void		CstWriteJson_PlaceObject2(JsonPrettyWriter &writer, idSWFBitStream &bitstream);
	static void		CstWriteJson_PlaceObject3(JsonPrettyWriter &writer, idSWFBitStream &bitstream);
	static void		CstWriteJson_RemoveObject2(JsonPrettyWriter &writer, idSWFBitStream &bitstream);
	static void		CstLoadJson_PlaceObject2(JsonValue &objPlace, CstSWFBitstream &cstBitstream, const idList<idStr> &characterIDs, idList<idStr> &errorMsg);
	static void		CstLoadJson_PlaceObject3(JsonValue &objPlace, CstSWFBitstream &cstBitstream, const idList<idStr> &characterIDs, idList<idStr> &errorMsg);
	static void		CstLoadJson_RemoveObject2(JsonValue &objRemove, CstSWFBitstream &cstBitstream, idList<idStr> &errorMsg);
	//#modified-fva; END
