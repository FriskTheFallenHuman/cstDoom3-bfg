...
public:
	...
	//#modified-fva; BEGIN
	static void CstInvalidateMouseInClientAreaFilter() { cstMouseInClientAreaFilter.xyValid = false; }
	void CstSetFreeze(bool _freeze) { cstFreeze = _freeze; }
	//#modified-fva; END
...
private:
	...
	//#modified-fva; BEGIN
	struct CstMouseInClientAreaFilter {
		CstMouseInClientAreaFilter() : showMouse(false), xyValid(false), x(0), y(0) {}
		bool showMouse;
		bool xyValid;
		int x;
		int y;
	};
	static CstMouseInClientAreaFilter cstMouseInClientAreaFilter;
	//#modified-fva; END
...
private:
	...
	//#modified-fva; BEGIN
	void			CstWriteJson(const idStr &fileName);
	void			CstWriteJson_Image(const idSWFDictionaryEntry &dictEntry, JsonPrettyWriter &writer, unsigned characterID);
	bool			CstWriteJson_Shape(const idSWFShape &shape, bool morph, JsonPrettyWriter &writer, unsigned characterID, idList<idStr> &errorMsg);
	void			CstWriteJson_Font(const idSWFFont &font, JsonPrettyWriter &writer, unsigned characterID);
	void			CstWriteJson_Text(const idSWFText &text, JsonPrettyWriter &writer, unsigned characterID);
	bool			CstWriteJson_EditText(const idSWFEditText &editText, JsonPrettyWriter &writer, unsigned characterID, idList<idStr> &errorMsg);
	bool			CstLoadJson(const idStr &fileName);
	void			CstLoadJson_Image(idSWFDictionaryEntry &dictEntry, JsonValue &objImage, idList<idStr> &errorMsg);
	void			CstLoadJson_Shape(idSWFShape &shape, bool morph, JsonValue &objShape, const idList<idStr> &characterIDs, idList<idStr> &errorMsg);
	void			CstLoadJson_Font(idSWFFont &font, JsonValue &objFont, idList<idStr> &errorMsg);
	void			CstLoadJson_Text(idSWFText &text, JsonValue &objText, const idList<idStr> &characterIDs, idList<idStr> &errorMsg);
	void			CstLoadJson_EditText(idSWFEditText &editText, JsonValue &objEditText, const idList<idStr> &characterIDs, idList<idStr> &errorMsg);
	//#modified-fva; END
	...
	//#modified-fva; BEGIN
	void			CstExportAtlas(const idStr &atlasFileName);
	//#modified-fva; END
...
struct CstJson {
	...
	// SWF_Load.cpp
	//----------------------------------
	static JsonValue &		Object_GetObject(JsonValue &obj, const char *key, idList<idStr> &errorMsg);
	static JsonValue &		Object_GetArray(JsonValue &obj, const char *key, idList<idStr> &errorMsg, int numElems = -1);

	static uint32			Object_GetUint(JsonValue &obj, const char *key, idList<idStr> &errorMsg, uint32 min, uint32 max);
	static uint8			Object_GetUint8(JsonValue &obj, const char *key, idList<idStr> &errorMsg);
	static uint16			Object_GetUint16(JsonValue &obj, const char *key, idList<idStr> &errorMsg);
	static uint32			Object_GetUint32(JsonValue &obj, const char *key, idList<idStr> &errorMsg);

	static int32			Object_GetInt(JsonValue &obj, const char *key, idList<idStr> &errorMsg, int32 min, int32 max);
	static int8				Object_GetInt8(JsonValue &obj, const char *key, idList<idStr> &errorMsg);
	static int16			Object_GetInt16(JsonValue &obj, const char *key, idList<idStr> &errorMsg);
	static int32			Object_GetInt32(JsonValue &obj, const char *key, idList<idStr> &errorMsg);

	static bool				Object_GetBool(JsonValue &obj, const char *key, idList<idStr> &errorMsg);
	static float			Object_GetFloat(JsonValue &obj, const char *key, idList<idStr> &errorMsg);
	static double			Object_GetDouble(JsonValue &obj, const char *key, idList<idStr> &errorMsg);
	static const char *		Object_GetString(JsonValue &obj, const char *key, idList<idStr> &errorMsg);

	static JsonValue &		Array_GetObject(JsonValue &_array, JsonSizeType index, idList<idStr> &errorMsg);
	static JsonValue &		Array_GetArray(JsonValue &_array, JsonSizeType index, idList<idStr> &errorMsg, int numElems = -1);

	static uint32			Array_GetUint(JsonValue &_array, JsonSizeType index, idList<idStr> &errorMsg, uint32 min, uint32 max);
	static uint8			Array_GetUint8(JsonValue &_array, JsonSizeType index, idList<idStr> &errorMsg);
	static uint16			Array_GetUint16(JsonValue &_array, JsonSizeType index, idList<idStr> &errorMsg);
	static uint32			Array_GetUint32(JsonValue &_array, JsonSizeType index, idList<idStr> &errorMsg);

	static int32			Array_GetInt(JsonValue &_array, JsonSizeType index, idList<idStr> &errorMsg, int32 min, int32 max);
	static int8				Array_GetInt8(JsonValue &_array, JsonSizeType index, idList<idStr> &errorMsg);
	static int16			Array_GetInt16(JsonValue &_array, JsonSizeType index, idList<idStr> &errorMsg);
	static int32			Array_GetInt32(JsonValue &_array, JsonSizeType index, idList<idStr> &errorMsg);

	static bool				Array_GetBool(JsonValue &_array, JsonSizeType index, idList<idStr> &errorMsg);
	static float			Array_GetFloat(JsonValue &_array, JsonSizeType index, idList<idStr> &errorMsg);
	static double			Array_GetDouble(JsonValue &_array, JsonSizeType index, idList<idStr> &errorMsg);
	static const char *		Array_GetString(JsonValue &_array, JsonSizeType index, idList<idStr> &errorMsg);
};
//#modified-fva; END
