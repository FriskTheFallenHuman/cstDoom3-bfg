...
public:
	...
	//#modified-fva; BEGIN
	static bool CstWriteJson_DoAction(JsonPrettyWriter &writer, idSWFBitStream &bitstream, idList<idStr> &errorMsg);
	static bool CstWriteJson_DoInitAction(JsonPrettyWriter &writer, idSWFBitStream &bitstream, idList<idStr> &errorMsg);
	static void CstLoadJson_DoAction(JsonValue &objDoAction, CstSWFBitstream &cstBitstream, idList<idStr> &errorMsg);
	static void CstLoadJson_DoInitAction(JsonValue &arrayDoInitAction, CstSWFBitstream &cstBitstream, idList<idStr> &errorMsg);
	//#modified-fva; END

private:
	idSWFScriptVar Run( idSWFScriptObject * thisObject, idSWFStack & stack, idSWFBitStream & bitstream );
	//#modified-fva; BEGIN
	static bool CstWriteJson_Actions(JsonPrettyWriter &writer, idSWFBitStream &bitstream, idList<idStr> &errorMsg);
	static void CstLoadJson_Actions(JsonValue &arrayActions, CstSWFBitstream &cstBitstream, idList<idStr> &errorMsg);
	//#modified-fva; END
