...
//#modified-fva; BEGIN
idCVar cst_amZoomStep("cst_amZoomStep", "1.2", CVAR_FLOAT | CVAR_ARCHIVE, "zoom step used by the automap step zoom commands", 1.0f, idMath::INFINITY);
idCVar cst_amZoomSpeed("cst_amZoomSpeed", "1.04", CVAR_FLOAT | CVAR_ARCHIVE, "zoom speed used by the automap zoom buttons", 1.0f, idMath::INFINITY);
idCVar cst_amPanSpeed("cst_amPanSpeed", "3", CVAR_FLOAT | CVAR_ARCHIVE, "pan speed used by the automap pan buttons", 1.0f, idMath::INFINITY);
idCVar cst_amFollowOnStart("cst_amFollowOnStart", "0", CVAR_BOOL | CVAR_ARCHIVE, "activate follow mode when the automap is started");
idCVar cst_dcScreenInvul("cst_dcScreenInvul", "0", CVAR_INTEGER | CVAR_ARCHIVE, "invulnerability screen effect (doom 1 and 2): 0 = fullscreen, 1 = status bar, 2 = off", 0, 2);
idCVar cst_dcScreenSuit("cst_dcScreenSuit", "0", CVAR_INTEGER | CVAR_ARCHIVE, "rad suit screen effect (doom 1 and 2): 0 = fullscreen, 1 = status bar, 2 = off", 0, 2);
idCVar cst_dcScreenBerserk("cst_dcScreenBerserk", "0", CVAR_INTEGER | CVAR_ARCHIVE, "berserk screen effect (doom 1 and 2): 0 = fullscreen, 1 = status bar, 2 = off", 0, 2);
idCVar cst_dcScreenPickup("cst_dcScreenPickup", "0", CVAR_INTEGER | CVAR_ARCHIVE, "pickup screen flash (doom 1 and 2): 0 = fullscreen, 1 = status bar, 2 = off", 0, 2);
idCVar cst_dcScreenDamage("cst_dcScreenDamage", "0", CVAR_INTEGER | CVAR_ARCHIVE, "damage screen flash (doom 1 and 2): 0 = fullscreen, 1 = status bar, 2 = off", 0, 2);
idCVar cst_dcNoMuzzleFlash("cst_dcNoMuzzleFlash", "0", CVAR_BOOL | CVAR_ARCHIVE, "disable weapon muzzle flashes (doom 1 and 2)");
idCVar cst_dcNoTeleportFog("cst_dcNoTeleportFog", "0", CVAR_BOOL | CVAR_ARCHIVE, "disable the fog effect when leaving a teleporter (doom 1 and 2)");
idCVar cst_dcOldNightmareSP("cst_dcOldNightmareSP", "0", CVAR_BOOL | CVAR_ARCHIVE, "restore the original difficulty of the nightmare skill (doom 1 and 2)");
//#modified-fva; END
